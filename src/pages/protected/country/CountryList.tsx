            ...
            return(
              <div  key={key} className={`pb-3 transition-all duration-300 overflow-hidden border shdow-md border-main mb-4 rounded-2xl px-2 sm:px-3 
                ...
                <div className='flex-center flex-wrap'>
                    <DropDownItem  title='Country Name' content={item.countryName}/>
                    <DropDownItem  title='Continent' content={item.continent}/>
                    <DropDownItem  title='Country Flag' flagUrl={item.flag}/>
                    <DropDownItem  title='Created By' content={item.createdAt}/>
                    <DropDownItem  title='Edited On' content={item.editedAt}/>
